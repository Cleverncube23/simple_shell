...
/**
 * read_history - Reads history from the history file and builds the history list.
 * @info: Pointer to the parameter struct.
 *
 ...
 * @info: Pointer to the parameter struct.
 * @buf: Buffer containing the command to be added to the history list.
 * @linecount: The history linecount (histcount) of the new entry.
 *
 * Return: Always 0.
 */
 ...
 * @info: Pointer to the parameter struct.
 *
 * Return: The new histcount (history linecount).
 */
